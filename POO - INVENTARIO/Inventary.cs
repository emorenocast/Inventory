...
public class Inventario
{
    ...
    foreach (var producto in ListadeProductos)
    {
       ...
       public void salidaDeInventario() {
        ...
        public void ajustePositivosDeInventario() {
        string codigo = "";
        string cantidad = "";
        ...
        Console.WriteLine("Ingreso de Ajustes Positivos de Inventario");
        Console.WriteLine("****");
        Console.Write("Ingrese el codigo del producto: ");
        codigo = Console.ReadLine();
        Console.Write("Ingrese la cantidad del producto: ");
       ...
       public void ajusteNegativosDeInventario() {
       string codigo = "";
       string cantidad = "";
       ...
       Console.WriteLine("Salida de Ajustes Negativos de Inventario");
       Console.WriteLine("****");
       Console.Write("Ingrese el codigo del producto: ");
       codigo = Console.ReadLine();
       Console.Write("Ingrese la cantidad del producto: ");
